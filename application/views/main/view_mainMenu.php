        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-5">
            <div class="card-body px-5 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Manage Main Menu</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="<?php echo base_url('Dashboard/dashboard'); ?>">Home</a>
                                </li>
                                <li class=" breadcrumb-item" aria-current="page">Manage Main Menu
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row py-2 mt-2">
                            <span class="fs-5 fw-bold text-primary-emphasis mb-5">Register Main Menu</span>
                            <div class="row ">
                                <div class="col-lg-3 p-t-20 mb-3">
                                    <div>Main Menu<span class="red-text">*</span></div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                                <h5 class="modal-title text-center" id="exampleModalLabel1">SELECT ALL ICON</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- Icon container -->
                                <section class="section white icons-list">
                                    <div class="pagewidth">
                                        <h3 class="mb-4">Arrows &amp; Direction Icons </h3>
                                        <div class="icon-section card icon-card cursor-pointer text-center mb-4 mx-2">
                                            <div class="icon-container icon-section card icon-card cursor-pointer text-center mb-4 mx-2 ">
                                        ...
                                        <h3 class="mb-4">Web App Icons</h3>
                                        <div class="icon-section card icon-card cursor-pointer text-center mb-4 mx-2">
                                            <div class="icon-container icon-section card icon-card cursor-pointer text-center mb-4 mx-2">
                                        ...
                                        <h3 class="mb-4">Control Icons</h3>
                                        <div class="icon-section card icon-card cursor-pointer text-center mb-4 mx-2">
                                            <div class="icon-container icon-section card icon-card cursor-pointer text-center mb-4 mx-2">
